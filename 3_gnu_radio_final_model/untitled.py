...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "UART over OOK Decoder", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("UART over OOK Decoder")
        ...
        # Variables
        ##################################################
        self.samples_per_bit = samples_per_bit = 50
        self.samp_rate = samp_rate = 2400000
        self.baud_rate = baud_rate = 2400
        self.time_sink_total_points = time_sink_total_points = 120000
        self.samples_per_symbol = samples_per_symbol = int(samp_rate / baud_rate / samples_per_bit)
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            (int(time_sink_total_points / samples_per_symbol)), #size
            samp_rate, #samp_rate
            "Synchronized UART Signal", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.blocks_keep_one_in_n_0 = blocks.keep_one_in_n(gr.sizeof_float*1, samples_per_symbol)
        ...
        self.connect((self.blocks_unpacked_to_packed_xx_0, 0), (self.epy_block_0, 0))
    ...
    def set_samples_per_bit(self, samples_per_bit):
        ...
        self.set_samples_per_symbol(int(self.samp_rate / self.baud_rate / self.samples_per_bit))
