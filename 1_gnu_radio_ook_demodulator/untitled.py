...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "OOK 433MHz Demodulator", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OOK 433MHz Demodulator")
        ...
        # Variables
        ##################################################
        self.time_sink_total_points = time_sink_total_points = 60000
        ...
        self.rtlsdr_source_0.set_center_freq(433.988e6, 0)
        ...
        self.qtgui_time_sink_x_0_1 = qtgui.time_sink_c(
            time_sink_total_points, #size
            samp_rate, #samp_rate
            "Input Modulated Signal", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.qtgui_time_sink_x_0_1, 0))
    ...
    def get_time_sink_total_points(self):
        return self.time_sink_total_points

    def set_time_sink_total_points(self, time_sink_total_points):
        self.time_sink_total_points = time_sink_total_points
